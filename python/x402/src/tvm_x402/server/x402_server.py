...
class X402Server:
    ...
    def _register_default_tron_mechanisms(self) -> None:
        ...
        from tvm_x402.mechanisms.server import UptoTronServerMechanism
        ...
        if self._facilitators:
            ...
            if fee_quote:
                if requirements.extra is None:
                    from tvm_x402.types import PaymentRequirementsExtra
...
from tvm_x402.facilitator.facilitator_client import FacilitatorClient
