...
from tvm_x402.abi import get_payment_permit_eip712_types
...
from tvm_x402.utils import convert_permit_to_eip712_message

if TYPE_CHECKING:
    from tvm_x402.signers.client import ClientSigner
