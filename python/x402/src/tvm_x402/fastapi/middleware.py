...
from tvm_x402.server import X402Server, ResourceConfig
from tvm_x402.encoding import decode_payment_payload, encode_payment_payload
from tvm_x402.types import PaymentPayload, PaymentRequired
...
class X402Middleware:
    ...
    async def _verify_transaction_on_chain(
        ...
        Returns:
            TransactionVerificationResult
        """
        from tvm_x402.utils.tx_verification import (
